...
| Multi-device sync scenarios | [smoke-sync.spec.ts](smoke-sync.spec.ts) | [smoke-sync.md](smoke-sync.md) | Spec is the codified subset (Steps 1, 2, 4, 6, 7, 9 — storage-layer driver); runbook is the full UI walk. Needs two contexts + a test account |
