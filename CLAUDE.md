...
| Calc | `src/lib/metrics.ts` (GH/KH/TDS math, range findings, NNLS dosing solver), `src/lib/constants.ts` (mineral DB, presets, conversion constants + the shared ion/mineral types) |
